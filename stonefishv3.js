(function () {
  ...
  function capturableMaterialProfile(game, state, color) {
    // Stonefish v3 uses the user's exact hanging definition:
    // after a candidate move, find every Stonefish piece the opponent could
    // legally capture on the very next turn. Count each capturable piece once.
