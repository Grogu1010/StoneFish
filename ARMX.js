...
const ARMX_FULL = Object.freeze({
  ...
  responseEffectScale: 0.065,
  pieceBaselinePrior: 0.22,
  pieceBaselinePriorWeight: 8,
  extendedReplyOutcomeScale: 0.72,
  ...
  fullNoteMinEvidence: 5.0,
  fullNoteMinConfidence: 0.58,
  fullNoteMinDecisionLead: 0.5,
  fullNoteMinPositiveSignal: 0.025,
  fullNoteStrongAvoidSignal: -0.10,
  fullNoteEarlyPlies: 14,
  fullNoteEarlyEvidence: 7.0,
  fullNoteEarlyConfidence: 0.78,
  ...
  maxStyleAdjustment: Object.freeze({athena: 70, ares: 75, artemis: 0}),
  ...
  styleProfiles: Object.freeze({
    ...
    athena: Object.freeze({
      weights: Object.freeze({
        capture:-0.03, trade:-0.04, rookTrade:-0.03, queenTrade:-0.04,
        minorTrade:-0.03, simplify:-0.04, check:-0.02, kingAttack:-0.02,
        pawnPush:-0.01, castle:0.04, quiet:0.06, advance:-0.01, retreat:0.03,
        forcing:-0.02, promotion:0.01, center:0.01, kingside:0.01,
        queenside:0.01, centralize:0.01, development:0.01, pawnMove:-0.01,
        knightMove:0.01, bishopMove:0.01, rookMove:0, queenMove:-0.01, kingMove:0.02,
      }),
      ...
      baseScale:2, earlyBoost:0.35, lateBoost:-0.05, paceTargetPlies:260,
      aheadThreshold:150, behindThreshold:150, advantageRange:300, minStyleLead:18,
      ...
      opponentKingAttackReplyWeight:0, behindKingAttackReplyWeight:0,
      opponentCaptureReplyWeight:0, behindCaptureReplyWeight:0,
      aheadHostGapBonus:40, aheadDeepGapBonus:28, behindHostGapBonus:48, behindDeepGapBonus:30,
      maxHostGap:2, maxDeepSacrifice:2,
    }),
    ares: Object.freeze({
      weights: Object.freeze({
        capture:0.03, trade:0.01, rookTrade:0.02, queenTrade:0.01,
        minorTrade:0.01, simplify:0.02, check:0.03, kingAttack:0.04,
        pawnPush:0.01, castle:0, quiet:-0.02, advance:0.02, retreat:-0.02,
        forcing:0.03, promotion:0.05, center:0.01, kingside:0.01,
        queenside:0.01, centralize:0.01, development:0.01, pawnMove:0.01,
        knightMove:0.01, bishopMove:0.01, rookMove:0.01, queenMove:0.01, kingMove:-0.01,
      }),
      aheadWeights:Object.freeze({
      ...
      baseScale:2, earlyBoost:0.02, lateBoost:8.40, paceTargetPlies:42,
      aheadThreshold:100, behindThreshold:140, advantageRange:300, minStyleLead:15,
      ...
      patientOpponentScale:1.15, aggressiveOpponentScale:0.00,
      patientPressureWeight:3.20, aggressiveDefenseWeight:0,
      opponentForcingReplyWeight:0, behindForcingReplyWeight:0,
      opponentKingAttackReplyWeight:0, behindKingAttackReplyWeight:0,
      opponentCaptureReplyWeight:0, behindCaptureReplyWeight:0,
      aheadHostGapBonus:72, aheadDeepGapBonus:48, behindHostGapBonus:0, behindDeepGapBonus:0,
      maxHostGap:2, maxDeepSacrifice:2,
    }),
  }),
});
