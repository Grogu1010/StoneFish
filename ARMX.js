...
const ARMX_FULL = Object.freeze({
  ...
  maxStyleAdjustment: Object.freeze({athena: 130, ares: 140, artemis: 0}),
  ...
  styleProfiles: Object.freeze({
    ...
    athena: Object.freeze({
      weights: Object.freeze({
        capture:-0.80, trade:-1.20, rookTrade:-0.95, queenTrade:-1.15,
        minorTrade:-0.85, simplify:-1.15, check:-0.45, kingAttack:-0.60,
        pawnPush:0.30, castle:1.20, quiet:1.40, advance:-0.20, retreat:0.80,
        forcing:-0.55, promotion:0.08, center:0.12, kingside:0.08,
        queenside:0.10, centralize:0.16, development:0.20, pawnMove:0.12,
        knightMove:0.10, bishopMove:0.10, rookMove:0.02, queenMove:-0.06, kingMove:0.18,
      }),
      ...
      baseScale:8, earlyBoost:2.00, lateBoost:-0.20, paceTargetPlies:260,
      aheadThreshold:90, behindThreshold:60, advantageRange:300, minStyleLead:3,
      aheadScale:3.20, behindScale:4.80, replyCompressionWeight:-1.20,
      aheadReplyCompressionWeight:-8.50, behindReplyCompressionWeight:-5.50, capturedValueWeight:-1.10,
      ...
      aheadHostGapBonus:72, aheadDeepGapBonus:50, behindHostGapBonus:55, behindDeepGapBonus:36,
      maxHostGap:3, maxDeepSacrifice:3,
    }),
    ares: Object.freeze({
      weights: Object.freeze({}),
      aheadWeights:Object.freeze({
      ...
      baseScale:3, earlyBoost:0.00, lateBoost:9.00, paceTargetPlies:42,
      aheadThreshold:35, behindThreshold:120, advantageRange:280, minStyleLead:4,
      aheadScale:3.20, behindScale:0.20, replyCompressionWeight:0,
      aheadReplyCompressionWeight:5.50, behindReplyCompressionWeight:0, capturedValueWeight:2.10,
      ...
      patientPressureThreshold:0.24, patientPressureRange:0.16,
      patientPressureWeight:24.00, aggressiveDefenseWeight:0,
      opponentForcingReplyWeight:0, behindForcingReplyWeight:0,
      opponentKingAttackReplyWeight:0, behindKingAttackReplyWeight:0,
      opponentCaptureReplyWeight:0, behindCaptureReplyWeight:0,
      aheadHostGapBonus:42, aheadDeepGapBonus:30, behindHostGapBonus:0, behindDeepGapBonus:0,
      maxHostGap:3, maxDeepSacrifice:3,
    }),
  }),
});
