...
const ARMX_FULL = Object.freeze({
  ...
  styleProfiles: Object.freeze({
    ...
    athena: Object.freeze({
      weights: Object.freeze({
        capture:-1.20, trade:-1.55, rookTrade:-1.35, queenTrade:-1.45,
        minorTrade:-1.25, simplify:-1.50, check:-0.58, kingAttack:-0.68,
        pawnPush:-0.42, castle:0.90, quiet:1.65, advance:-0.28, retreat:0.82,
        forcing:-0.62, promotion:0.05, center:0.10, kingside:0.06,
        queenside:0.08, centralize:0.18, development:0.18, pawnMove:-0.38,
