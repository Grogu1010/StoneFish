...
const ARMX_FULL = Object.freeze({
  ...
  maxStyleAdjustment: Object.freeze({athena: 105, ares: 115, artemis: 0}),
  ...
  styleProfiles: Object.freeze({
    ...
    athena: Object.freeze({
      weights: Object.freeze({
        capture:-0.14, trade:-0.18, rookTrade:-0.16, queenTrade:-0.17,
        minorTrade:-0.15, simplify:-0.18, check:-0.07, kingAttack:-0.08,
        pawnPush:-0.05, castle:0.12, quiet:0.20, advance:-0.03, retreat:0.10,
        forcing:-0.07, promotion:0.02, center:0.03, kingside:0.02,
        queenside:0.03, centralize:0.05, development:0.05, pawnMove:-0.05,
      ...
      aheadThreshold:70, behindThreshold:80, advantageRange:340, minStyleLead:12,
      ...
      opponentKingAttackReplyWeight:0, behindKingAttackReplyWeight:0,
      opponentCaptureReplyWeight:0, behindCaptureReplyWeight:0,
      aheadHostGapBonus:58, aheadDeepGapBonus:39, behindHostGapBonus:90, behindDeepGapBonus:50,
      maxHostGap:4, maxDeepSacrifice:4,
    }),
    ares: Object.freeze({
      weights: Object.freeze({
        capture:0.10, trade:0.05, rookTrade:0.06, queenTrade:0.05,
        minorTrade:0.05, simplify:0.07, check:0.10, kingAttack:0.13,
        pawnPush:0.04, castle:-0.01, quiet:-0.07, advance:0.05, retreat:-0.08,
        forcing:0.10, promotion:0.18, center:0.03, kingside:0.04,
      ...
      baseScale:4, earlyBoost:0.05, lateBoost:8.40, paceTargetPlies:42,
      aheadThreshold:5, behindThreshold:100, advantageRange:360, minStyleLead:10,
      ...
      opponentKingAttackReplyWeight:0, behindKingAttackReplyWeight:0,
      opponentCaptureReplyWeight:0, behindCaptureReplyWeight:0,
      aheadHostGapBonus:150, aheadDeepGapBonus:102, behindHostGapBonus:0, behindDeepGapBonus:0,
      maxHostGap:5, maxDeepSacrifice:5,
    }),
  }),
});
