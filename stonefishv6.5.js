(function () {
  ...
  function fullOnlyAntiKIAStart(game, state, color) {
    ...
    move._stonefishOpeningName = "Stonefish v6.5 Full Anti-KIA Counterstrike";
  ...
  window.StonefishV65 = {
    ...
    _stonefishDepthProfile: "v6.5 full architecture: same v6 ply profile, staged always-on finalist verification, faster cache-heavy scoring, opponent-plan suppression, and conversion pressure"
  };
})();
