// Experimental native v5.5: full legal-move alpha-beta and capture quiescence.
// Loaded after testunit1; both variants call the same host. No opponent identity
...
function sf55cQ(g,ctx,alpha,beta,ply,remaining){
  ...
  if(!check)moves=moves.filter(m=>m.captured||m.promotion);
...
stonefishV55Testunit1HostSearch=sf55cHost;
globalThis.stonefishV55Testunit1HostSearch=sf55cHost;
