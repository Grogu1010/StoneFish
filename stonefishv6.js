(function () {
  ...
  window.StonefishV6 = {
    ...
    _stonefishDepthProfile: "v6 full architecture with always-on two-ply terminal verification, opponent-plan preparedness scoring, all-candidate danger checks, and book safety"
  };
})();
