...
vm.runInThisContext(['StonefishChess.js', 'ARMX-preview.js']
...
console.log('ARMX_CONTRACT passed: side isolation, undo, opening exclusion, attribution, evidence, board purity');
